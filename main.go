...
func init() {
	solutions = []day{
		...
		{"Day 19 solution:", func() {
			day19.Day19(ReadInputBlockString("./day19/input.txt"))
		}},
		{"Day 20 solution:", func() {
			day20.Day20(ReadInputBlockByte("./day20/input.txt"))
		}},
		...
		{"Day 24 solution:", func() {
			day24.Day24(ReadInputBlockString("./day24/input.txt"))
		}},
		{"Day 25 solution:", func() {
			day25.Day25(ReadInputBlockString("./day25/input.txt"))
		}},
	}
}
